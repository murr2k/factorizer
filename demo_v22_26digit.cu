/**
 * CUDA Factorizer v2.2.0 - 26-digit Test Case Demo
 * Focused implementation for the challenge number
 */
...
// Optimized Pollard's Rho for 26-digit number
__global__ void pollards_rho_26digit(
    uint128_t n,
    uint128_t* factor,
    int* found,
...
int main() {
    ...
    // Launch kernel
    pollards_rho_26digit<<<num_blocks, threads_per_block>>>(n, d_factor, d_found);
