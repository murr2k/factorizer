/**
 * Improved 128-bit CUDA Factorizer
 * Integrates all three hive-mind improvements:
 * 1. Barrett reduction for fast modular arithmetic
 * 2. Corrected uint128_t multiplication with proper carry handling
...
uint128_t string_to_uint128(const char* str) {
    ...
    for (int i = 0; str[i] != '\0'; i++) {
        ...
        uint128_t ten(10, 0);
        result = multiply_128_128(result, ten).low_128();
